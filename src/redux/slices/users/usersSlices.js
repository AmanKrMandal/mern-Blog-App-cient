...
export const userProfileAction = createAsyncThunk(
  ...
  async (id, { rejectWithValue, getState, dispatch }) => {
    //http call
    try {
      const { data } = await axiosInterceptors.get(`/api/users/profile/${id}`);
      return data;
    } catch (error) {
      if (!error?.response) {
        throw error;
...
export const followUserAction = createAsyncThunk(
  ...
  async (userToFollowId, { rejectWithValue, getState, dispatch }) => {
    //http call
    try {
      const { data } = await axiosInterceptors.put(`/api/users/follow`, {
...
export const unfollowUserAction = createAsyncThunk(
  ...
  async (unFollowId, { rejectWithValue, getState, dispatch }) => {
    //http call
    try {
      const { data } = await axiosInterceptors.put(`/api/users/unfollow`, {
        unFollowId,
      });
      return data;
    } catch (error) {
...
export const updateUserAction = createAsyncThunk(
  ...
  async (userData, { rejectWithValue, getState, dispatch }) => {
    //http call
    try {
      const { data } = await axiosInterceptors.put(`/api/users`, {
...
export const updatePasswordAction = createAsyncThunk(
  ...
  async (password, { rejectWithValue, getState, dispatch }) => {
    //http call
    try {
      const { data } = await axiosInterceptors.put(`/api/users/password`, {
        password,
      });
      //dispatch
...
export const fetchUserDetailsAction = createAsyncThunk(
  ...
  async (id, { rejectWithValue, getState, dispatch }) => {
    try {
      const { data } = await axiosInterceptors.get(`/api/users/${id}`);
      return data;
    } catch (error) {
...
export const fetchUsersAction = createAsyncThunk(
  ...
  async (id, { rejectWithValue, getState, dispatch }) => {
    try {
      const { data } = await axiosInterceptors.get(`/api/users`);
      return data;
    } catch (error) {
      if (!error?.response) throw error;
      return rejectWithValue(error?.response?.data);
