...
export const createCategoryAction = createAsyncThunk(
  ...
  async (category, { rejectWithValue, getState, dispatch }) => {
    //http call
    try {
      const { data } = await axiosInterceptors.post(`/api/category`, {
...
export const fetchCategoriesAction = createAsyncThunk(
  ...
  async (category, { rejectWithValue, getState, dispatch }) => {
    //http call
    try {
      const { data } = await axiosInterceptors.get(`/api/category`);
      return data;
    } catch (error) {
      if (!error?.response) {
        throw error;
...
export const deleteCategoriesAction = createAsyncThunk(
  ...
  async (id, { rejectWithValue, getState, dispatch }) => {
    //http call
    try {
      const { data } = await axiosInterceptors.delete(`/api/category/${id}`);
      //dispatch action
...
export const fetchCategoryAction = createAsyncThunk(
  ...
  async (id, { rejectWithValue, getState, dispatch }) => {
    //http call
    try {
      const { data } = await axiosInterceptors.get(`/api/category/${id}`);
      return data;
    } catch (error) {
      if (!error?.response) {
        throw error;
